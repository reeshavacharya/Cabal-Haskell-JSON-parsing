...
/* package fetch-0.1.0.0 */
#ifndef VERSION_fetch
#define VERSION_fetch "0.1.0.0"
#endif /* VERSION_fetch */
#ifndef MIN_VERSION_fetch
#define MIN_VERSION_fetch(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_fetch */
...
#define CURRENT_COMPONENT_ID "fetch-0.1.0.0-inplace-fetch"
